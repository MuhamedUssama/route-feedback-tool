...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function()?  noConfig,TResult Function( List<GroupConfigModel> groups,  Map<String, Map<String, int>> groupStats,  Set<String> loadingGroupNames,  String? errorMessage)?  ready,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _NoConfig() when noConfig != null:
return noConfig();case _Ready() when ready != null:
return ready(_that.groups,_that.groupStats,_that.loadingGroupNames,_that.errorMessage);case _Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function()  noConfig,required TResult Function( List<GroupConfigModel> groups,  Map<String, Map<String, int>> groupStats,  Set<String> loadingGroupNames,  String? errorMessage)  ready,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loading():
return loading();case _NoConfig():
return noConfig();case _Ready():
return ready(_that.groups,_that.groupStats,_that.loadingGroupNames,_that.errorMessage);case _Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function()?  noConfig,TResult? Function( List<GroupConfigModel> groups,  Map<String, Map<String, int>> groupStats,  Set<String> loadingGroupNames,  String? errorMessage)?  ready,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _NoConfig() when noConfig != null:
...
class _Ready implements ReportState {
  const _Ready({required final  List<GroupConfigModel> groups, required final  Map<String, Map<String, int>> groupStats, final  Set<String> loadingGroupNames = const {}, this.errorMessage}): _groups = groups,_groupStats = groupStats,_loadingGroupNames = loadingGroupNames;
  

 final  List<GroupConfigModel> _groups;
 List<GroupConfigModel> get groups {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Ready&&const DeepCollectionEquality().equals(other._groups, _groups)&&const DeepCollectionEquality().equals(other._groupStats, _groupStats)&&const DeepCollectionEquality().equals(other._loadingGroupNames, _loadingGroupNames)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_groups),const DeepCollectionEquality().hash(_groupStats),const DeepCollectionEquality().hash(_loadingGroupNames),errorMessage);

@override
String toString() {
  return 'ReportState.ready(groups: $groups, groupStats: $groupStats, loadingGroupNames: $loadingGroupNames, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 List<GroupConfigModel> groups, Map<String, Map<String, int>> groupStats, Set<String> loadingGroupNames, String? errorMessage
});
...
/// Create a copy of ReportState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? groups = null,Object? groupStats = null,Object? loadingGroupNames = null,Object? errorMessage = freezed,}) {
  return _then(_Ready(
groups: null == groups ? _self._groups : groups // ignore: cast_nullable_to_non_nullable
as List<GroupConfigModel>,groupStats: null == groupStats ? _self._groupStats : groupStats // ignore: cast_nullable_to_non_nullable
